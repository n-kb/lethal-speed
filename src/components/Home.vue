      ...
      <div class="container is-fluid">
        <div class="columns">
          <div class="column is-2 is-offset-10">
            <shareitem title="Cars, speed and cigarettes" shareText="Share" description="Cars are not means of transportation. They really are more like cigarettes."></shareitem>
          </div>
        </div>
        <div class="columns">
          <div class="column is-half is-offset-one-quarter">
            <div class="content">
              <h1 class="title is-1 has-text-centered is-size-3-mobile">Cars, speed and cigarettes</h1>
              <div class="columns">
                <div class="column has-text-centered">
                  <p class="byline">An essay by <strong><a href="https://blog.nkb.fr" class="byline--link">Nicolas Kayser-Bril</a></strong></p>
                </div>
                <div class="column byline has-text-centered">
                  <p class="byline">15 October 2018</p>
                </div>
              </div>
              <div class="article-content">
                <p>
                  I recently published a piece, <a href="http://blog.nkb.fr/license-to-kill/" target="_blank">Licence to Kill</a>, showing how little car and truck drivers had to fear from the Berlin judicial system after they killed someone. Several commenters pointed out that car drivers did not <em>kill</em>. They had <em>accidents</em>.
                </p>
                <p>
                  To illustrate the fault with such thinking, I created the tool below that lets you calculate your lethal speed. The lethal speed is the speed over which an impact between you or your vechicle and a pedestrian is certain to cause the pedestrian severe injury.
                </p>
                <calculator @callback="updateVars"/>
                <p>
                  A {{ vehicle.type }} weighting {{ total_weight }} (in total) traveling at {{ Math.round(speed) }} km per hour has a kinetic energy of about {{ (6800).toLocaleString('en') }} joules. If it hit someone at that speed, the shock would be similar that of a human body falling from twelve meters on concrete - a 100% chance of severe injury.<note content="A <a href='https://ntrs.nasa.gov/archive/nasa/casi.ntrs.nasa.gov/19930020462.pdf' target='_blank'>NASA paper from 1992</a> summarized experiments done in the field of survival to acceleration (see figure 9 page 35). A deceleration of 15m/s to 0 in .4 seconds is about 40 Gs, which NASA puts in the <em>area of severe injury</em>." note_number=1 />
                </p>
                <p>
                  This computation only gives orders of magnitude. Semi-trailers and SUVs are especially dangerous because of their ability to crush bodies under their wheels, for instance.<note content="For a description of how SUV kill more than sedans, see <a href='http://archive.is/nfiFx#selection-55.1-55.61' target='_blank'>Death on foot: America's love of SUVs is killing pedestrians</a>, a 2018 report by the Detroit Free Press." note_number=2 /> When two pedestrians or bicycles hit one another, each bears a share of the impact, making the shock for each one less intense. Every impact is unique but their outcome is always an issue of mass and speed.
                <p>
                  In an area where people can unexpectedly encounter your path, such as a city, if something bad happens while travelling with a ton of steel faster than 12 km per hour, it cannot be called an accident. While some drivers are very careful to avoid impacts, moving around with enough energy to kill a person on the spot implies, <em>in itself</em>, some disregard for other people's lives. Bicycles, on the other hand, only become dangerous when driven over 40 km/h.
                </p>
                <p>
                  The disregard of car manufacturers and drivers for the life of others becomes blatant when looking at the evolution of safety devices. Pedestrian (external) airbags first entered production in 2012 on the Volvo V40. As of 2018, no other Volvo model offers them.<note content='Some <a href="http://archive.is/Cot1L" target="_blank">background</a> on the Volvo pedestrian airbag. The same is true of the <em>Pedestrian Protection System</em> of Range Rover. It was introduced in 2014 on the Discovery Sport but has not been mounted on other models since then.' note_number=3 /> By contrast, passenger airbags were first introduced in the late 1980s and had become standard equipment in most cars in the early 1990s, less than five years later.<note content='On the history of passenger airbags, read the <a href="http://archive.is/bhhJJ#selection-439.0-439.18" target="_blank">History of Airbags</a> at Did You Know Cars.' note_number=4 /> Although the post-impact survival of pedestrians (since 2009) and cyclists (since 2018) has become part of the safety ratings made by Euro NCAP, a para-governmental organization focusing on car safety, the industry has yet to take it into account and market it accordingly - and regulators have yet to make external airbags mandatory.
                </p>
                <p>
                ...
                <p>
                  Don't get me wrong, I love driving. I just believe that it should be seen for what it is: a recreational activity for people who love expensive, polluting toys. Cars belong in the same category as Jet Skis or go-karts.
                </p>
                
                <h3>Cars and cigarettes</h3>

                <p>
                  Cars are woefully inadapted to transport people within cities.<note content="On the unability of cars to transport people, see Arieff, Allison. <a href='https://www.nytimes.com/interactive/2018/02/27/opinion/automated-vehicles-cant-save-cities.html' target='_blank'>Automated Vehicles Can't Save Cities</a>, New York Times, 27 February 2018." note_number=11 /> Despite this shortcoming, car driving is heavily subsidized and encouraged by all governments and administrations, bar the handlful of towns that reorganized themselves to get rid of private vehicles.<note content="Ponteverda in Spain, for instance. (<a href='https://www.theguardian.com/cities/2018/sep/18/paradise-life-spanish-city-banned-cars-pontevedra' target='_blank'>See this Guardian article</a>.) Wikipedia has an interesting <a href='https://en.wikipedia.org/wiki/List_of_car-free_places' target='_blank'>list of car-free places</a>." note_number=12 /> That goverments push destructive policies is nothing new. Car driving should be put in the same category as other programs with extremely negative outcomes that were encouraged or enabled by governments, such as smoking.<note content="On the history of government responses to smoking, I use mostly Robert Proctor's <em>Golden Holocaust</em>. On the role of governments in the nicotin addiction epidemic, see the links between tobacco and the military, for instance in the United States in the 1980s and 1990s: Smith, Elizabeth A., and Ruth E. Malone. <em>“Everywhere the soldier will be”: wartime tobacco promotion in the US military.</em> American journal of public health 99.9 (2009): 1595-1602. In the United Kingdom in the 1950s: Richards, H. J. A., and J. P. Crowdy. <em>Smoking habits of young soldiers.</em> British journal of preventive & social medicine 15.2 (1961): 84. There are more studies in other countries showing that conscription increases smoking rates among young males." note_number=13 />
                </p>
                <p>
                  Arguing that cars are for transportation is a bit like arguing that cigarettes are for helping digestion. It sounds absurd now, but it was a common theme in cigarette advertising in the 1930s.<note content="<a href='https://www.thecrimson.com/article/1936/2/28/for-digestions-sake-smoke-camels-plife-gets/' target='_blank'>For digestion's sake, smoke Camels</a> was a common advertising theme until the 1930's." note_number=14 /> Cars and cigarettes share much more than misleading advertising. Both are status symbols, used first by white men and second by those who sought to emulate them. Enticing self-assertive women to buy SUVs is not different from pushing them towards smoking two generations ago.
                </p>

                <h3>Rationality will not help</h3>

                <p>
                  Cars, unlike cigarettes, are not addictive. While any effort to curb smoking only becomes visible when a new cohort of non-smokers comes of age (current smokers are unlikely to cure their addiction before they die),<note content="A longitudinal study in the United Kingdom showed that one in five smokers quit over a period of 10 years. I could not find data on lifelong quitters but I suspect the number is lower. Chandola, T., Head, J., & Bartley, M. (2004). Socio-demographic predictors of quitting smoking: how important are household factors? Addiction, 99(6), 770–777." note_number=15 /> curbs on car driving will have immediate effects.
                </p>
                <p>
                ...
                <p>
                  It was only in the 1990s that cigarette manufacturers began to lose the fight in the U.S. and, a few years later, in Europe. The direct reason is that judges began to rule in favor of plaintiffs (usually smokers with cancer),<note content='Douglas, Clifford E., Ronald M. Davis, and John K. Beasley. "Epidemiology of the third wave of tobacco litigation in the United States, 1994–2005." Tobacco control 15.suppl 4 (2006): iv9-iv16.' note_number=16 /> culminating in the Master Settlement Agreement of 1998 when top tobacco companies agreed to pay for some of the health care bills of smokers. While I could not find research on why the reversal happened in the early 1990s, I suspect that the cigarette industry decided to abandon the fight in the U.S. to invest more in China and the former Soviet Union, two much larger markets that opened at the time.
                </p>
                <p>
                  Private cars are closer to cigarettes than to any means of transportation because their primary use is not transport but display of status. This is the reason why - as happened with cigarettes - rational arguments against car culture do not work. Only legal and political actions will help us fight the car epidemic.
                </p>
